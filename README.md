...
### Outputs
Let's explain what the `mnms` settings mean. We defer that discussion for the `dr5`, `dr6`, or `dr6v3` block to an understanding of `soapack`, but in short it defines the default locations of raw data.
